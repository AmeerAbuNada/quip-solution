                                        ...
                                        <div class="row mb-6" style="height: 100%">
                                            ...
                                            <div class="col-lg-9 fv-row">
                                                ...
                                                <input class="form-check-input mt-2" id="active"
                                                    ...
                                                    value="1" @checked($project->is_active) />
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="row mb-6">
                                            <div class="col-lg-6 fv-row">
                                                ...
                                                <div class="col-lg-12 fv-row">
                                                    <textarea id="description_en" class="form-control form-control-lg form-control-solid">{{ $project->description_en }}</textarea>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <div class="col-lg-6 fv-row">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-12 fv-row">
                                                    <textarea id="description_ar" class="form-control form-control-lg form-control-solid">{{ $project->description_ar }}</textarea>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                        </div>
...
@section('scripts')
    ...
    <script>
        function performStore() {
            ...
            let url = '{{ route('projects.update', $project) }}';
