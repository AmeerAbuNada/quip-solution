											...
											<div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="right-start">
												...
												<div class="menu-sub menu-sub-dropdown w-175px py-4">
													...
													<div class="menu-item px-3">
														...
														<span class="symbol symbol-20px me-4">
															<img class="rounded-1" src="{{asset('dashboard-assets/media/flags/palestine.svg')}}" alt="" />
														</span>Arabic</a>
													</div>
													<!--end::Menu item-->
												</div>
					...
					<div id="kt_header" style="" class="header align-items-stretch">
						...
						<div class="header-brand">
							...
							<a href="{{route('dashboard.index')}}">
								<img alt="Logo" src="{{asset('dashboard-assets/imgs/logo3.png')}}" style="background: white; border-radius: 10px" class="h-30px h-lg-30px" />
							</a>
							<!--end::Logo-->
