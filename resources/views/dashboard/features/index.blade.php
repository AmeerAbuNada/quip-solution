                        ...
                        <table class="table align-middle table-row-dashed table-hover fs-6 gy-5" id="kt_table_users">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    <th>#</th>
                                    <th>{{ __('features.name_en') }}</th>
                                    <th>{{ __('features.name_ar') }}</th>
                                    <th>{{ __('features.active') }}</th>
                                    <th>{{ __('features.created_at') }}</th>
                                    <th>{{ __('features.actions') }}</th>
                                </tr>
                                <!--end::Table row-->
                            </thead>
                            <!--end::Table head-->
...
@section('scripts')
    ...
    <script>
        ...
        function toggleOptions(id, type, ref) {
            ...
            put(`/dashboard/features/${id}/toggle`, data);
        }
