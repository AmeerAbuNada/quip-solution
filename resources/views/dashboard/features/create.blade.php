                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card-header border-0">
                                ...
                                <div class="card-title m-0">
                                    <h3 class="fw-bolder m-0">{{ __('features.add') }}</h3>
                                </div>
                                <!--end::Card title-->
                            </div>
                            <!--begin::Card header-->
                            ...
                            <div id="kt_account_settings_profile_details" class="collapse show">
                                ...
                                <form class="form" onsubmit="event.preventDefault(); performStore();">
                                    ...
                                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                                        ...
                                        <button type="submit" class="btn btn-primary" id="submit-btn">{{__('add_new')}}</button>
                                    </div>
                                    <!--end::Actions-->
                                </form>
                                <!--end::Form-->
...
@section('scripts')
    ...
    <script>
        function performStore() {
            ...
            let url = '{{ route('features.store') }}';

            post(url, gatherData(), 'submit-btn', '{{ route('features.index') }}');
        }
